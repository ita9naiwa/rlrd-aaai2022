...
if __name__ == "__main__":
    ...
    with open("../knapsackmodels/distillation/" + distillation_file_name + ".torchmodel", "rb") as f:
    ...
    with open("../knapsackmodels/localrl/" + reinforce_file_name + ".torchmodel", "rb") as f:
        tmp = torch.load(f, map_location=torch.device("cpu"))
    ...
    for i in range(NUM_TEST):
        ...
        # Distillation + Gumbel
        gum_start = time.time()
        gumbel_value = test_gumbel(env, d_model, 30)
        gum_end = time.time()
